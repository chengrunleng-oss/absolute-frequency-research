...
| --- | --- | --- | --- | --- |
| 二阶塞曼 | `Delta nu = k B^2` | `k=-4.89264(88) Hz/mT^2`，`B=0.10084(20) mT` | `-140.7(0.6)e-18` | 基本可以 |
| 引力红移 | `Delta f/f = g h / c^2`，`h=H-N` | `g=9.7803(3) m/s^2`，`H=23.68(10) m`，`N=7.89(10) m` | `1718(36)e-18` | 基本可以 |
